...
// src/widget/ImageGalleryWidget.tsx
...
function readGlobal(key) {
  ...
  return openai[key] ?? defaultGlobals[key];
}
function useOpenAiGlobal(key) {
  ...
  const getSnapshot = (0, import_react.useCallback)(() => readGlobal(key), [key]);
  return (0, import_react.useSyncExternalStore)(subscribe, getSnapshot, () => defaultGlobals[key]);
}
...
function useWidgetState() {
  ...
  const openai = (0, import_react.useMemo)(() => {
    try {
      return getOpenAi();
    } catch (error) {
      console.warn(error);
  ...
  const [widgetState, setWidgetStateLocal] = (0, import_react.useState)(
    stateFromHost
  );
...
function ImageGalleryWidget() {
  ...
  const numberFormatter = (0, import_react2.useMemo)(() => new Intl.NumberFormat(locale), [locale]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        toolOutput ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_react2.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              "p",
              {
                ...
                children: [
                  "Showing ",
                  toolOutput.resultCount,
                  " image",
                  toolOutput.resultCount === 1 ? "" : "s",
                  " \xB7 Locale: ",
                  locale
                ]
              }
          ...
          hasResults ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "div",
            {
              style: {
                display: "grid",
                gap: "12px",
                gridTemplateColumns: displayMode === "fullscreen" ? "repeat(auto-fill, minmax(240px, 1fr))" : "repeat(auto-fill, minmax(160px, 1fr))"
              },
              children: results.map((image) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                ImageCard,
                {
                  image,
          ...
          ) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, { query: toolOutput.query }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Attribution, { text: toolOutput.attribution })
        ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { margin: 0 }, children: "Waiting for image search results\u2026" }),
        displayMode === "inline" && (toolOutput?.resultCount ?? 0) > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
            type: "button",
            onClick: () => {
            ...
            children: "Expand gallery"
          }
        ) : null,
        focusedImage ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "div",
          {
            role: "dialog",
            "aria-modal": "true",
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              "div",
              {
                style: {
                  ...
                  overflow: "hidden",
                  display: "grid",
                  gridTemplateColumns: userAgent.device.type === "desktop" || userAgent.device.type === "tablet" ? "minmax(0, 3fr) minmax(0, 2fr)" : "1fr",
                  gap: "0px"
                },
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", justifyContent: "space-between" }, children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "h3",
                            {
                              ...
                              children: focusedImage.tags.length ? focusedImage.tags.join(", ") : toolOutput?.query ?? "Pixabay image"
                            }
                          ),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "button",
                        ...
                        focusedImage.tags.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", flexWrap: "wrap", gap: "8px" }, children: focusedImage.tags.map((tag) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: chipStyle, children: [
                          "#",
                          tag
                        ] }, tag)) }) : null,
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", gap: "12px", marginTop: "auto" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                          "button",
                          {
                            type: "button",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "h3",
                  {
                    ...
                    children: image.tags.length ? image.tags.join(", ") : "Pixabay image"
                  }
                ),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  "p",
                  {
                    ...
                    children: [
                      ...
                      " \xB7",
                      " ",
                      numberFormatter.format(image.likes),
                      " likes \xB7",
                      " ",
                      numberFormatter.format(image.downloads),
                      " downloads"
                    ]
                  }
                )
              ] }),
              image.tags.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexWrap: "wrap", gap: "6px" }, children: [
                image.tags.slice(0, 4).map((tag) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: chipStyle, children: [
                  "#",
                  tag
                ] }, tag)),
                image.tags.length > 4 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: chipStyle, children: [
                  "+",
                  image.tags.length - 4
                ] }) : null
              ] }) : null,
...
function EmptyState({ query }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { style: { margin: 0, fontSize: "0.95rem", color: "#3f4752" }, children: [
        "We couldn't find images for \u201C",
        query,
        "\u201D. Try broadening the description or removing filters."
      ] })
    }
  );
}
...
function MetadataRow({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "4px" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "span",
      {
        style: {
...
function buildAltText(image, query) {
...
var ROOT_ELEMENT_ID = "pixabay-gallery-root";
function mount() {
  ...
  root.render(
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react3.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ImageGalleryWidget, {}) })
  );
}
